...
- المكتبة الشاملة متعددة التصنيفات (40 تصنيفًا، وكتب التفسير وحدها موزَّعة على التصنيفات 3 و4 و5؛ فضيّق نطاق البحث والتصفّح بالتصنيف المناسب عبر category_id.
...
- القراءة فقط؛ لا تُكتب ملفات الشاملة أبدًا.`,
    ...
    resources: {
        ...
        // مجمَّد هنا يخالف العنوان الذي يقدّمه.
        categories: {
