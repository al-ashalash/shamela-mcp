...
- **\`shamela_dump_book\`** — إخراج الكتاب كلَّه نصًّا مرتَّبًا للفهرسة أو المعالجة الآلية لا للقراءة: كل صفحة بمتنها وحاشيتها وعنوان بابها وإحالتها الجاهزة، على دفعات يُستأنف بها الكتاب حتى آخره. وللقراءة استعمل \`shamela_get_page\` و\`shamela_get_pages_range\`.
  مثال: «صدِّر لي متن الكتاب ٩٩٤٢ كاملًا لأفهرسه في نظامي.»`,
