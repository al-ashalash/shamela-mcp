...
- **\`shamela_search_authors\`** — البحث في فهرس المؤلفين بالاسم أو نص الترجمة؛ وعند غياب النتيجة جرِّب الكنية والنسبة والشهرة مضمومةً إلى الاسم لا وحدها («ابن قدامة المقدسي» لا «المقدسي»، فهي وحدها تطابق تسعةً وستين مؤلّفًا)؛ و«ال» لا تفرّق.
...
- **\`shamela_list_categories\`** — قائمة بكل تصنيفات المكتبة (٤٠ تصنيفًا) مع عدد الكتب وعدد المنزَّل منها في كل تصنيف.
...
- **\`shamela_resolve\`** — تعيين الكتاب أو المؤلف المقصود في فهارس الشاملة من اسمٍ عربي ولو نقصت كلماتُه — والمطابقة بالكلمة التامّة: «قدامة» تجد، و«قدام» لا تجد شيئًا.
...
**ضيِّق النطاق بالتصنيفات.** المكتبة ٤٠ تصنيفًا، وكتب التفسير وحدها موزَّعة على ثلاثة تصنيفات (التفسير، وعلوم القرآن وأصول التفسير، والتجويد والقراءات). اطلب حصر البحث في التصنيف المناسب («ابحث في كتب الفقه الحنبلي فقط») تصفُ النتائج وتسرع.
