...
- **\`shamela_books_by_period\`** — تصفية فهرس الكتب زمنيًّا: بسنة تأريخ الكتاب في الشاملة، أو بسنة وفاة مؤلفه الرئيس. وتنبَّه إلى أنّ سنة التأريخ عندهم ليست سنة التأليف، بل تتبع وفاة مؤلِّف الأصل.
