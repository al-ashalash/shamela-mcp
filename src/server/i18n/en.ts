...
- For tafsir: get_tafseer_of_aya works from a curated index; to see which downloaded tafsirs actually cover a given verse, use shamela_list_tafsirs_for_aya.
...
- Read-only; Shamela's files are never written to.`,
    ...
    toolTitles: {
        ...
        shamela_resolve: "Resolve a name to an id",
        ...
        shamela_books_by_period: "Books by period (composition and death)",
        ...
        shamela_dump_book: "Export a whole book",
    },
