...
- أي سؤال عن قدرات الإضافة أو طريقة استخدامها — ولو بلفظ عام مثل «مساعدة» أو «الدليل» أو «كيف أبحث» أو «اشرح لي الإضافة» — → استدعِ shamela_guide واعرض محتواه كما هو دون اختصار. وإذا بدا المستخدم جديدًا أو كان طلبه الأول غامضًا، فاعرض عليه أولًا جولةً موجزة من قسمٍ مناسب من الدليل قبل المضي.`;
