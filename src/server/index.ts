...
export function createServer(getBackend: () => Promise<Backend>): McpServer {
    ...
    // ----------- 25. shamela_search_boolean (EXPERIMENTAL) -----------
    server.registerTool(
    ...
    // ----------- Resources (EXPERIMENTAL — attachable catalogs/schema) -----------
    ...
    // ----------- Prompts (EXPERIMENTAL — guided study workflows) -----------
...
async function main(): Promise<void> {
    ...
    // EXPERIMENTAL cold-start fix: warm the JVM + indexes right after the MCP
